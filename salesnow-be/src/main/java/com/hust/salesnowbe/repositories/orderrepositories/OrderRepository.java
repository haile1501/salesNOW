...
import com.hust.salesnowbe.dto.orderdtos.IOrderDetailInfo;
import com.hust.salesnowbe.dto.orderdtos.IOrderListItemDto;
import com.hust.salesnowbe.dto.orderdtos.OrderStatistical;
...
public interface OrderRepository extends JpaRepository<Order, Integer> {
    ...
    @Query("SELECT new com.hust.salesnowbe.dto.orderdtos.OrderStatistical(sum(o.quantity), count(distinct o.order.id), sum(o.price * o.quantity), :startDate) FROM OrderLine o WHERE o.createdAt >= :startDate AND o.createdAt <= :endDate")
...
//    @Query("SELECT new com.ict.salemanagement.dto.orderdtos.OrderStatistical(sum(o.quantity), count(distinct o.order.id), sum(o.price)) FROM OrderLine o WHERE o.createdAt >= :startDate AND o.createdAt <= :endDate")
