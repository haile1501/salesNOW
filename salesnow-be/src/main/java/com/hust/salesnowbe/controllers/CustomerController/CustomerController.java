package com.hust.salesnowbe.controllers.CustomerController;
...
import com.hust.salesnowbe.dto.customer.CustomerSpendingDTO;
import com.hust.salesnowbe.dto.customer.FeedbackDTO;
import com.hust.salesnowbe.dto.orderdtos.OrderListByCustomer;
import com.hust.salesnowbe.models.Customer;
import com.hust.salesnowbe.models.Feedback;
import com.hust.salesnowbe.services.CustomerServices.CustomerServices;
import com.hust.salesnowbe.services.CustomerServices.FeedbackService;
import com.hust.salesnowbe.services.OrderServices.OrderService;
...
public class CustomerController extends BaseController {
    ...
    public CustomerController(CustomerServices customerServices, FeedbackService feedbackService,
    ...
    @GetMapping("/customer")
    public ResponseEntity<PagedResponseObject> getAllCustomer(
    ...
    public ResponseEntity<PagedResponseObject> getAllCustomerBySpending(
            @RequestParam(value = "page", defaultValue = "1") int page,
            @RequestParam(value = "size", defaultValue = "10") int size) {
    ...
    // public ResponseEntity<ResponseObject> createCustomer(@Valid @RequestBody
    // Customer customer){
    ...
    // smsService.sendSMS(convertedPhoneNumber, "Chúc mừng bạn đã trở thành khách
    // hàng thân thiết của SalesNOW");
    // return ResponseEntity.ok(ResponseObject.builder()
    // .responseCode(200)
    // .message("Success")
    // .data(newCustomer)
    ...
    public ResponseEntity<ResponseObject> updateCustomer(@PathVariable("id") int customerId,
    ...
    public ResponseEntity<PagedResponseObject> getAllFeedback(@RequestParam(name = "page", defaultValue = "1") int page,
    ...
    public ResponseEntity<ResponseObject> createFeedback(@RequestBody @Valid FeedbackDTO feedbackDTO,
    ...
    public ResponseEntity<ResponseObject> updateFeedback(@PathVariable("id") int feedbackId,
            @RequestBody @Valid FeedbackDTO feedbackDTO, @AuthenticationPrincipal UserDetails userDetails) {
        String staffPhone = userDetails.getUsername();
