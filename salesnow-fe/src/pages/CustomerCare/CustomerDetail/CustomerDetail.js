        ...
        const fetchApi = async () => {
            try {
                ...
                setCustomer({
                    ...
                    totalReturnItems: result.totalReturnItems,
                    lastBuyDate: result.lastBuyDate,
                });
            } catch (error) {
                            ...
                            <div className={cx('personalInfoContentRow')}>
                                ...
                                <div className={cx('personalInfoValue')}>
                                    ...
                                    {purchaseInformation.totalReturnedQuantity ? (
                                        ...
                                        <span>{customer.totalReturnItems}</span>
                                    )}
                                </div>
                            </div>
                            ...
                            <div className={cx('personalInfoContentRow')}>
                                ...
                                <div className={cx('personalInfoValue')}>
                                    ...
                                    {purchaseInformation.lastPurchaseDate ? (
                                        ...
                                        <span>{customer.lastBuyDate}</span>
                                    )}
                                </div>
                            </div>
                        </div>
