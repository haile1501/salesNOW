...
function Dashboard() {
  ...
  const [selectedTopCustomer, setSelectedTopCustomer] = useState({
    value: "order",
    label: "Theo số đơn hàng",
  });
              ...
              <div className={cx("wrapValue")}>
                ...
                <div className={cx("itemValue")}>
                  <h5 style={{ color: "#0088FF" }}>
                    {numeral(figures.revenue).format("0,0")}
                  </h5>
                </div>
              </div>
            </div>
          ...
          <div className={cx("parameterItem")}>
            <div className={cx("wrapItem")}>
              ...
              <div className={cx("wrapValue")}>
                ...
                <div className={cx("itemValue")}>
                  <h5 style={{ color: "#0FD186" }}>
                    {numeral(figures.order).format("0,0")}
                  </h5>
                </div>
              </div>
            </div>
          ...
          <div className={cx("parameterItem")}>
            <div className={cx("wrapItem")}>
              ...
              <div className={cx("wrapValue")}>
                ...
                <div className={cx("itemValue")}>
                  <h5 style={{ color: "#FFAE06" }}>
                    {numeral(figures.product).format("0,0")}
                  </h5>
                </div>
              </div>
            </div>
          ...
          <div className={cx("parameterItem")}>
            <div className={cx("wrapItem")}>
              <div
                ...
                style={{
                  background:
                    "linear-gradient(65.71deg, #5e6472 28.29%, #5e7583 97.55%)",
                }}
              >
              ...
              <div className={cx("wrapValue")}>
                ...
                <div className={cx("itemValue")}>
                  <h5 style={{ color: "#5e6472" }}>
                    {numeral(figures.customer).format("0,0")}
                  </h5>
                </div>
              </div>
            </div>
      ...
      <div className={cx("content")}>
        <div className={cx("topProduct")}>
          ...
          <div className={cx("topProductContent")}>
                  ...
                  return (
                    <div className={cx("topProductItem")}>
                      ...
                      <div className={cx("itemName")}>
                        <div className={cx("itemNameProduct")}>
                          {item.variant.name}
                        </div>
                        <div className={cx("itemNameSKU")}>
                          {item.variant.sku}
                        </div>
                      </div>
            ...
            {topProduct?.length === 0 && (
              <div className={cx("listProductEmpty")}>
                Chưa có sản phẩm được bán
              </div>
            )}
          </div>
        </div>
