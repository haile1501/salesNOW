...
const privateRoutes = [
  ...
  {
    path: routesConfig.customerUpdate,
    component: CustomerUpdate,
    title: "Cập nhật thông tin khách hàng",
  },
  {
    path: routesConfig.customerGroup,
    component: CustomerGroup,
    title: "Danh sách nhóm khách hàng",
  },
  {
    path: routesConfig.customerDetailGroup,
    component: CustomerDetailGroup,
    title: "Chi tiết nhóm khách hàng",
  },
  {
    path: routesConfig.customerCreateGroup,
    component: CustomerCreateGroup,
    title: "Thêm mới nhóm khách hàng",
  },
  {
    path: routesConfig.customerResponse,
    component: CustomerResponse,
    title: "Danh sách phản hồi",
  },
  {
    path: routesConfig.productList,
    component: ProductList,
    title: "Danh sách sản phẩm",
  },
  {
    path: routesConfig.productDetail1,
    component: ProductDetail,
    title: "Chi tiết sản phẩm",
  },
  {
    path: routesConfig.productDetail2,
    component: ProductDetail,
    title: "Chi tiết sản phẩm",
  },
  {
    path: routesConfig.productCreate,
    component: ProductCreate,
    title: "Tạo sản phẩm",
  },
  {
    path: routesConfig.productUpdate1,
    component: ProductUpdate,
    title: "Cập nhật sản phẩm",
  },
  {
    path: routesConfig.productUpdate2,
    component: ProductUpdate,
    title: "Cập nhật sản phẩm",
  },
  {
    path: routesConfig.orderReturnDetail,
    component: OrderReturnDetail,
    title: "Chi tiết đơn trả hàng",
  },
  {
    path: routesConfig.ordersReturn,
    component: OrderReturnList,
    title: "Danh sách đơn trả hàng",
  },
  { path: routesConfig.order, component: Order, title: "Chi tiết đơn hàng" },
  {
    path: routesConfig.orderList,
    component: OrderList,
    title: "Danh sách đơn hàng",
  },
  {
    path: routesConfig.createReturnOrder,
    component: CreateOrderReturn,
    title: "Tạo đơn trả hàng",
  },
  {
    path: routesConfig.customerAll,
    component: CustomerAll,
    title: "Danh sách khách hàng",
  },
  {
    path: routesConfig.customerCreate,
  ...
  {
    path: routesConfig.statisticsGeneral,
    component: StatisticsGeneral,
    title: "Thống kê chung",
  },
  {
    path: routesConfig.statisticsSales,
    component: StatisticsSales,
    title: "Thống kê bán hàng",
  },
  {
    path: routesConfig.statisticsImport,
    component: StatisticsImport,
    title: "Thống kê nhập hàng",
  },
  {
    path: routesConfig.balancesCreate,
    component: BalanceCreate,
    title: "Tạo phiếu kiểm hàng",
  },
  {
    path: routesConfig.balancesList,
    component: BalanceList,
    title: "Danh sách kiểm hàng",
  },
  {
    path: routesConfig.balancesDetail,
    component: BalanceDetail,
    title: "Chi tiết phiếu kiểm",
  },
  {
    path: routesConfig.create_import_order,
    component: CreateImportOrder,
    title: "Tạo đơn nhập hàng",
  },
  {
    path: routesConfig.detail_import_order,
    component: ImportOrderDetail,
    title: "Chi tiết đơn nhập hàng",
  },
  {
    path: routesConfig.import_order,
    component: ImportOrderList,
    title: "Danh sách đơn nhập hàng",
  },
  {
    path: routesConfig.create_vendor,
    component: CreateVendor,
    title: "Thêm mới nhà cung cấp",
  },
  {
    path: routesConfig.vendor_update,
    component: UpdateVendor,
    title: "Cập nhật thông tin nhà cung cấp",
  },
  {
    path: routesConfig.vendor_detail,
    component: VendorDetail,
    title: "Chi tiết nhà cung cấp",
  },
  {
    path: routesConfig.vendor_list,
  ...
  {
    path: routesConfig.staffDetail,
    component: StaffDetail,
    title: "Thông tin nhân viên",
  },
  {
    path: routesConfig.staffCreate,
